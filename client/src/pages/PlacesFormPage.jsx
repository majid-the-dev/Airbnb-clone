...
function PlacesFormPage() {
    ...
    useEffect(() => { //this is to match the id of each place a register adds, check the route in app.js for the id param
        if (!id) {
            return;
        }
    ...
    async function savePlace(e) {
        ...
        if (id) {
            ...
            //it is a new place
            await axios.post('/places', {...placeData}); //the placeData can also be written bare here without the spread operator and curly braces
        }
        setRedirect(true);
    }
